...
import { updateDocumentAscess } from "@/lib/actions/room.actions";
...
const ShareModal = ({roomId,collaborators,creatorId,currentUserType}:ShareDocumentDialogProps) => {
    ...
    const shareDocumentHandler = async() => {   
      ...
      await updateDocumentAscess({roomId,
          email,
  ...
  return (
        ...
        <DialogContent className="shad-dialog">
            ...
            <Label htmlFor="email" className="pt-6 text-blue-100">Email address</Label>
